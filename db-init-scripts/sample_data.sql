...
values
 ...
 (
    5, '!org.novi.dsl.FalseActivationConfig("False-1") & (org.novi.dsl.FalseActivationConfig("False-2") | org.novi.dsl.TrueActivationConfig("True-3"))',
    'DSL', 'org.novi.web.activations.ComboBooleanActivations'
 );
